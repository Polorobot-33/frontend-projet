      ...
      <div class="flex flex-col items-center">
        ...
        <div class="flex flex-col items-center">
          ...
          <p class="relative mx-auto mt-4 w-[90vw] max-w-[400px] overflow-hidden rounded-2xl p-4 text-center text-sm text-white [box-shadow:inset_1px_1px_1px_rgba(255,255,255,0.75)] brightness-110 saturate-100 backdrop-blur-sm dark:[box-shadow:inset_1px_1px_1px_rgba(255,255,255,0.15)]">
            ...
            monde entier. Nos raisons sont nombreuses et jamais légitimes, mais
            vous avez en face de vous les mineurs les plus aigris de la promo.
            Nous avons même essayé de reproduire le liquid glass d’Apple dans un
            but satirique, mais le résultat est un site très lent à charger, aux
            visuels médiocres, et aussi responsive que Basile Marchand quand il
            n’a pas bu de café. C'est énervant, pas vrai le texte qui contraste
            pas assez avec le fond ??
            <br />
            <br />
